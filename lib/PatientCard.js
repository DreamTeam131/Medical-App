...
const PatientCard = ({ patient }) => {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.miniTitle}>Current Illness</Text>
      <Text style={styles.regularText}>{patient.current_illness}</Text>
      <Text style={styles.miniTitle}>Allergies</Text>
      <Text style={styles.regularText}>{patient.allergies}</Text>
      <Text style={styles.miniTitle}>Medications</Text>
      <Text style={styles.regularText}>{patient.medications}</Text>
    </View>
  )
}
