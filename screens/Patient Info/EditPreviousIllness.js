...
const EditMedical = ({ navigation, route}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        .from('patient_info')
        .update({previous_illness_info: info})
        .select()
        .eq('id' , id)
        .single()
    ...
    useEffect(() => {
        const fetchPatient = async () => {
            ...
            if ( data ) {
                setInfo(data.previous_illness_info)
                setFetchError(null)
            }
            if ( data.previous_illness_info == null){
                setInfo([])
            }
        }
        fetchPatient()
    ...
    <Formik onSubmit={handleSubmit}>
        ...
        <Button title='Cancel' onPress={() => navigation.navigate('OtherInfo',{id:id})}/>
        </View>
    </Formik>
